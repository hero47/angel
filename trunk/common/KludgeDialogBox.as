	...
	public class KludgeDialogBox {
		...
		*/
		...
		private static function assignListeners(myAlert:Sprite, alertOptions:AlertOptions):void {
			...
			var allInputs:Array = new Array();
			for (n = 0; n < alertOptions.inputs.length; n++) {
		...
		private static function createInputLabel(text:String, alertOptions:AlertOptions):TextField {
			var myTextField:TextField = new TextField();
			myTextField.textColor = alertOptions.textColour;
		...
		private static function createInputField(name:String, alertOptions:AlertOptions):TextField {
			var myTextField:TextField = new TextField();
			myTextField.textColor = alertOptions.textColour;
			myTextField.multiline = false;
